...
import com.solodroid.ecommerce.fragments.FragmentInfoTab4_Payment2;
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position)
        {
            switch (position){
                ...
                case 3 : return new FragmentInfoTab4_Payment2();
            }
            return null;
        }
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position){
                ...
                case 3 :
                    return getResources().getString(R.string.information_tab4);
            }
            return null;
        }
    }
