...
<div id="content" class="container col-md-12">
	...
	<div class="col-md-5">
		<form method="post">
			...
			<label>이메일 :</label><?php echo isset($error['email']) ? $error['email'] : '';?>
			<input type="email" class="form-control" name="email" value="<?php echo $previous_email; ?>"/>
			<br/>

		    <label>기존 비밀번호 :</label><?php echo isset($error['old_password']) ? $error['old_password'] : '';?>
			<input type="password" class="form-control" name="old_password"/>
			<br/>

		    <label>새로운 비밀번호 :</label><?php echo isset($error['new_password']) ? $error['new_password'] : '';?>
			<input type="password" class="form-control" name="new_password"/>
			<br/>

			<label>새로운 비밀번호 재입력 :</label><?php echo isset($error['confirm_password']) ? $error['confirm_password'] : '';?>
			<input type="password" class="form-control" name="confirm_password"/>
			<br/>

		    <input type="submit" class="btn-primary btn" value="수정" name="btnChange"/>		
		</form>
	<div class="col-md-5">
