...
<div id="content" class="container col-md-12">
	...
	?>
	<div class="col-md-12">
	<h1>메뉴 추가 <?php echo isset($error['add_menu']) ? $error['add_menu'] : '';?></h1>
	<hr />
	</div>
	...
	<div class="col-md-9">
	    ...
	    <label>구매가능상태 :</label><?php echo isset($error['serve_for']) ? $error['serve_for'] : '';?>
	...
	<div class="col-md-3">
		<div class="panel panel-default">
				<div class="panel-body">
					<input type="submit" class="btn-primary btn" value="추가" name="btnAdd" />&nbsp;
					<input type="reset" class="btn-danger btn" value="초기화"/>
				</div>
		</div>
	</div>
	</form>
