  	...
  	<div class="col-md-4 col-md-offset-4">
	      <div class="panel panel-default">
			  ...
			  <div class="panel-heading">
				  <center><h3>데이팜 관리자 시스템</h3></center>
				  <center>( DayFarm Android App Management )</center>
			  </div>
			  <div class="panel-body">
				...
				<br>
				    <form method="post">
							...
							<br>
							<button type="submit" name="btnLogin" class="btn btn-primary pull-right">입장하기</button><br><br>
				    </form>
				<a href="forget-password.php"><p class="pull-right">비밀번호 찾기</p></a>
			  </div>
			</div>
	</div>
</div>
